...
class IIWA14CanliftingRobosuiteEnv:
    """
    This class encapsulates the LiftCan task in Robosuite, especially for CRiSE 3 (adapted Reward function), while using
    the IIWA14 robot with locked linear axes.
