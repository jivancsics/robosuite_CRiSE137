...
class WipeArenaML(TableArena):
    ...
    def reset_arena(self, sim, start_pos=None, path_pos=None):
        """
        ...
        """
        # Sample/Set new initial position and direction for generated marker paths
        ...
        for i, marker in enumerate(self.markers):
            ...
            # Sample/Set next values in local marker trajectory
            if path_pos is None:
                pos = self.sample_path_pos(pos)
            else:
                pos = path_pos[i:i+2]
