...
def pre_trained_meta3_maml_trpo(ctxt, seed, epochs, episodes_per_task, meta_batch_size):
...
if __name__ == "__main__":
    ...
    pre_trained_meta3_maml_trpo(seed=args.seed, epochs=args.epochs, episodes_per_task=args.episodes_per_task,
