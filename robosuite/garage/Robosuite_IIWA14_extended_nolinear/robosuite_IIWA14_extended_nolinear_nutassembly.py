...
class IIWA14NutassemblyRobosuiteEnv:
    """
    This class encapsulates the NutAssemblyMixed task in Robosuite for CRiSE 1/7 while using the
    ...
    def set_task(self, task):
        ...
        x_range_round = [self._last_rand_vec[3], self._last_rand_vec[3]]
        y_range_round = [self._last_rand_vec[4], self._last_rand_vec[4]]
        rotation_round = self._last_rand_vec[5]
